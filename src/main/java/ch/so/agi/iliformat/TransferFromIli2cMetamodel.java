...
//    Iterator modelI = umlModel.iteratorOwnedElement();
...
//    }
  ...
  static java.util.ResourceBundle rsrc = ch.ehi.basics.i18n.ResourceBundle.getBundle(ch.ehi.umleditor.interlis.iliimport.TransferFromIli2cMetamodel.class);
